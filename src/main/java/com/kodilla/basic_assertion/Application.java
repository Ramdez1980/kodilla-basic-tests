...
public class Application {
    public static void main(String[] args) {
        ...
        int numberC = 9;
        int numberD = 2;
        int sumResult = calculator.adingNumber(numberA, numberB);
        int subResult = calculator.substractNumber(numberA, numberB); // zadanie domowe 3.5.1//
        int powerResult = calculator.power(numberC, numberD);
